...
export const Navbar = ({ setShowMenu, showMenu }) => {
  return (
    <div className="flex justify-center w-full px-0 lg:px-3 py-4 bg-[#5264a7] text-white">
      <div className="w-full px-2 flex gap-2 justify-between items-center">
        ...
        <div className="flex gap-4 w-9/12 justify-around">
          ...
          <button className="bg-gray-600 hover:bg-gray-700 rounded  hove text-white px-2 py-1 text-xs">
